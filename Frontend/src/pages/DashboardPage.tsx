          ...
          <div className='grid gap-6 pb-32 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'>
            {notes.length === 0 ? (
              ...
              notes.map((note) => (
                <div
                  key={note.id}
                  className={`p-4 rounded-xl border ${note.isCompleted
                    ? "bg-green-900/20 border-green-500/30"
                    : "bg-[#111827] border-white/10"
                    }`}
                >
                  <p
                    className={`text-sm ${note.isCompleted ? "line-through text-gray-400" : ""
                      }`}
                  >
                    {note.content}
                  </p>
        ...
        <div className='max-w-6xl mx-auto px-6 py-3'>
          ...
          <div className="flex gap-3 items-center">
            ...
            <Button
              ...
              className={`shadow-lg cursor-pointer ${listening
