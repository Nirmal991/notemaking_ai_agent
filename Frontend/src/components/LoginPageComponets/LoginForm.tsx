      ...
      <Card className='bg-[#111827]/80 backdrop-blur border border-white/10 rounded-2xl shadow-2xl' >
        <CardContent className='p-8'>
          ...
          <form
            ...
            <div className='flex flex-col gap-2'>
              ...
              <div className='relative'>
                ...
                />
                {errors.password && (
                  <p className='absolute left-0 top-full mt-1 text-xs text-red-400'>{errors.password.message}</p>
                )}
              </div>
            </div>
          ...
          <p className='text-center text-sm text-gray-400 mt-6'>
            ...
            <Link to='/register'
              className="text-indigo-400 hover:text-indigo-300"> Create one</Link>
          </p>
        </CardContent>
      </Card>
    </div>
